...
This is the Trae adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Trae's skill system.

## Agent-Specific Behavior

- Trae reads skills from `.trae/skills/` directory.
