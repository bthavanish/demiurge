...
# Demiurge for Rovo Dev

This is the Rovo Dev (Atlassian) adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Rovo Dev's skill system.

## Agent-Specific Behavior

- Rovo Dev reads skills from `.rovodev/skills/` directory.
