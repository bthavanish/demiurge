...
This is the Pi adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Pi's skill system.

## Agent-Specific Behavior

- Pi reads skills from `.pi/skills/` directory.
