...
# Demiurge for Trae CN

This is the Trae CN adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Trae CN's skill system.

## Agent-Specific Behavior

- Trae CN reads skills from `.trae-cn/skills/` directory.
