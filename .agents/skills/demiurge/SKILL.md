...
# Demiurge for Generic Agents

This is the generic agent adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with generic agent systems.

## Agent-Specific Behavior

- Generic agents use `$demiurge` command prefix.
