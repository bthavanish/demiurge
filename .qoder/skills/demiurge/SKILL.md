...
This is the Qoder adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Qoder's skill system.

## Agent-Specific Behavior

- Qoder reads skills from `.qoder/skills/` directory.
