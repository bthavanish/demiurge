...
This is the Cursor adapter. It reads the root `SKILL.md` as the canonical source.
...
All modes, rules, and references are defined in the root `SKILL.md`. This file exists only to register the skill with Cursor's skill system.

## Agent-Specific Behavior

- Cursor uses `preToolUse` hooks (before edit, not after).
