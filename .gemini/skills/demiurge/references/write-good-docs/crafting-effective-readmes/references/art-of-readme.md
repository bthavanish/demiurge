...
German, French and Traditional Chinese.*
...
A reader<sup>1</sup> suggested that the title README may be a playful nudge toward Lewis
...
before the rest of the directory's content<sup>2</sup>.
